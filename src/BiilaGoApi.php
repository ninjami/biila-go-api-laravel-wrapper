...
{
    use ForwardsCalls;
    use Traits\PartnerEndpoints,
        Traits\OfficeEndpoints,
        Traits\ShopEndpoints,
        Traits\ReservationEndpoints;

    protected BiilaGoApiHttp $http;

    /**
     * The BiilaGoApi constructor.
     *
     * @param BiilaGoApiHttp $http
     */
    public function __construct(BiilaGoApiHttp $http)
    {
        $this->http = $http;
    }
     ...
     *
     * @return BiilaGoApiHttp
     */
    public function getHttp(): BiilaGoApiHttp
    {
        return $this->http;
    }

    /**
     * Forward calls to the biila-go-api-http instance.
     *
     * @param string $method
